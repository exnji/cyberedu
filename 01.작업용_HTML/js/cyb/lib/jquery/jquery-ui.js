...
$.extend(Datepicker.prototype, {
	...
	_enableDatepicker: function(target) {
		...
		if (nodeName === "input") {
			...
			inline.find("select.ui-datepicker-year, select.ui-datepicker-month").
				prop("disabled", false);
		}
		...
		for (row = 0; row < numMonths[0]; row++) {
			...
			for (col = 0; col < numMonths[1]; col++) {
				...
				for (dow = 0; dow < 7; dow++) { // days of the week
					day = (dow + firstDay) % 7;
					thead += "<th scope='col'" + ((dow + firstDay + 6) % 7 >= 5 ? " class='ui-datepicker-week-end sun'" : "") + ">" +
						"<span title='" + dayNames[day] + "'";
					if (dayNames[day] == '토')
					{
						thead += " class='sat'";
					}
					thead  += ">" + dayNamesMin[day] + "</span></th>";
				}
				...
				for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (dow = 0; dow < 7; dow++) { // create date picker days
						...
						tbody += "<td class='" +
							((dow + firstDay + 6) % 7 == 5 ? " ui-datepicker-week-end sat" : "") + // highlight weekends
							((dow + firstDay + 6) % 7 == 6 ? " ui-datepicker-week-end sun" : "") + // highlight weekends
